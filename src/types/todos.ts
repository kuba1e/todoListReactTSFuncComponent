...
export enum TodosActionType {
  ...
  ACTION_SEND_TO_UPDATE_TODO_ORDER = 'ACTION_SEND_TO_UPDATE_TODO_ORDER',
...
export interface ISendToUpdateTodoOrder {
  type: TodosActionType.ACTION_SEND_TO_UPDATE_TODO_ORDER
  payload: ITodo
}
